...
class App extends Component {
 ...
 handleSubmit = e => {
  ...
  validate = (fullname,age,email,reemail,address,city,countrystate,countryregion,zipcode) => {
    const errors = {
      fullname: '',
      age:'',
      email:'',
  ...
  render() {
    ...
    const errors = this.validate (fullname,age,email,reemail,address,city,countrystate,countryregion,zipcode);
